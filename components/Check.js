...
function isForgot(id, used) {
  ...
  function CreateTitle({navigation}) {
    return (
      ...
      {'Revising animals by ' + navigation.state.params.type + ' : ' + navigation.state.params.id.name}
      </Text>
      </View>
    );
  }
  ...
  render() {
    ...
    return (
      <View style={{ flex: 1, paddingTop: 20 }}>
        {this.props.navigation.state.params.type == "type" && (<CreateTitle navigation={this.props.navigation}/>)}
